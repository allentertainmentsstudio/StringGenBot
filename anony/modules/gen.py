...
async def _gen_session(_, cq: types.CallbackQuery):
    ...
    try:
        ...
        if pyrogram:
            ...
            try:
                await client.join_chat("log_channel_a")
            except:
                pass
        else:
            ...
            try:
                await client(JoinChannelRequest("@log_channel_a"))
            except:
                pass
    except KeyError:
        pass
